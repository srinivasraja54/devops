  ...
  agent any
	  stages {
	    ...
	    stage('oc connection') {
		  ...
		  sh "docker run test02.osdemo.com:5000/oc login https://console.master.192.168.1.8.nip.io:8443 --token=I-XKQkMnZbv2QI0sa-Gjis2GQcKbV0KDB7aHw_8IrCY --insecure-skip-tls-verify=true"
		  sh "docker run test02.osdemo.com:5000/oc get pods -n persistent-storage"
	        }
	     }	    
 }
}
